...
O foco principal é aprender a **passar comportamento como parâmetro**, conceito essencial para eventos e componentes como botões no Java Swing.
...
.gitignore: para ignorar pastas de build (bin/) e arquivos de IDE
...
### 10) Pequeno desafio - Botão com listener 🖱️
